...
// Usando a coluna 'duracao' correta do banco de dados
...
<body>
        ...
        <div class="carousel-container">
            <div class="carousel-track">
                <div class="carousel-slide">
                    <img src="/bookstyle_salao/pages/img/imgcorte.png" alt="Imagem da barbearia">
                </div>
                <div class="carousel-slide">
                    <img src="/bookstyle_salao/pages/img/imgbarba.png" alt="Imagem de um corte de cabelo e barba">
                </div>
                <div class="carousel-slide">
                    <img src="/bookstyle_salao/pages/img/imgtintura.png" alt="Produtos para cabelo e barba">
                </div>
            </div>
    ...
    <div class="container services-page" style="margin-top: 0;">
        <h2 class="title-decorated"><?php echo $titulo_pagina; ?></h2>
        ...
        <div class="services-grid">
            <?php if ($servicos->num_rows > 0): ?>
                ...
                <?php endwhile; ?>
            <?php else: ?>
                <p style="text-align: center; grid-column: 1 / -1;">Nenhum serviço encontrado nesta categoria.</p>
            <?php endif; ?>
        </div>
    </div>
